  ...
  <aside class="app-sidebar">
                ...
                <div class="tile">
                    <div class="tile-body">
                        <div class="row element-button">
                            <div class="col-sm-2">
                              <a class="btn btn-add btn-sm" href="form_add_taiKhoan.php" title="Thêm"><i class="fas fa-plus"></i>
                                Tạo tài khoản mới</a>
                            </div>
                          ...
                          <table class="table table-hover table-bordered" id="sampleTable">
                              <?php
                                  if(isset($_SESSION['id_user']))
                                  {
                                      ...
                                      $sql="SELECT id_taiKhoan, taiKhoan, matKhau, id_user, ltk.tenLoai as tenLoai,tk.tenNganHang,tk.maPinThe, tk.id_maTK
                                      FROM taikhoan tk INNER JOIN loaitaikhoan ltk on tk.id_maTK=ltk.id_maTK
                                      where id_user=$id_user order by id_taiKhoan desc";
                                      $p->getTaiKhoan($sql);
                                  }
                                  
                                  if(isset($_REQUEST['nut']) && $_REQUEST['nut']=="Xóa")
                                  {
                                      if(isset($_REQUEST['id_xoa']))
                                      {
                                          $id_xoa=$_REQUEST['id_xoa'];
                                          $sql="delete from taikhoan where id_taiKhoan='$id_xoa'";
                                          ...
                                          {
                                              echo '<script>swal("Thất bại", "Xóa thất bại", "error");</script>';
                                          }
                                      }
                                  }
    ...
    <script>
      function togglePassword(button) {
          var input = button.previousElementSibling; // Lấy ô input ngay trước nút nhấn
