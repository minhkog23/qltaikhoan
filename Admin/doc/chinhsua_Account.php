...
<div class="formbold-main-wrapper">
  <div class="formbold-form-wrapper">
    <form method="POST">
        <h2 align="center" style="padding: 20px 0px;">Chỉnh sửa thông tin</h2>
          ...
          <div class="form-group">
              ...
              <input type="text" name="txtho" id="txtho" class="form-control" value="<?php echo $ho; ?>"/>
          </div>
          <div class="form-group mt-3">
              <label for="lastname" class="form-label"> Tên <span style="color:red">*</span></label>
              <input type="text" name="txtten" id="txtten" value="<?php echo $ten; ?>"class="form-control"/>
          </div>
          <div class="form-group mt-3">
              <label for="lastname" class="form-label"> Số điện thoại <span style="color:red">*</span></label>
              <input type="text" name="txtsdt" id="txtsdt" value="<?php echo $email; ?>"class="form-control"/>
          </div>
          <!-- <div class="form-group mt-3">
    ...
    <?php
        if(isset($_POST['nut']) && $_POST['nut']=="Lưu")
        {
            if($_POST['txtho']=="" || $_POST['txtten']=="" || $_POST['txtsdt']=="")
            {
            ...
            else
            {
                ...
                $sql="UPDATE users SET Ho='$txtho',Ten='$txtten',email='$txtsdt' WHERE id_user=$id_user";
                $kq=$p->themxoasua($sql);
                if($kq==1)
                {
                    echo '<script>
